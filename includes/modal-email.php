			...
			<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" role="form">	
				...
				<!-- EMAIL TO-->
					<div class="input-group mb-3">
						...
						<input class="form-control" name="email-to" type="email" value="<?php echo $gb_email; ?>" disabled>						
					</div>
				<!-- SUBJECT -->
					<div class="input-group mb-3">
						<div class="input-group-prepend">
				...
				<!-- MESSAGE -->																	
					...
					<button class="btn btn-primary float-right" type="submit" name="submit">Send</button>	
